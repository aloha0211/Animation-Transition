...
//        animate();
    ...
    private void setupTransitions() {
        ...
        // ExpandedScene
        mExpandedScene = Scene.getSceneForLayout(detailContainer, R.layout.activity_album_detail_expand, this);
        ...
        // CollapsedScene
        mCollapsedScene = Scene.getSceneForLayout(detailContainer, R.layout.activity_album_detail, this);
...
//        scaleFab.playTogether(scaleX, scaleY);
        ...
        animationSet.playSequentially(animatorTitle, animatorTrack, scaleFab);
        animationSet.start();
    }
